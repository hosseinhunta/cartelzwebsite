    ...
    <div className="text-white bg-gradient-to-b from-slate-800 to-slate-950 antialiased px-4">
      ...
      <main className="py-12 w-full max-w-[28rem] mx-auto tracking-normal antialiased leading-relaxed text-justify">
        <h1 className="mb-5 text-3xl font-bold">
          اتصال به سرور با کانتر 1.6 استیم
        </h1>
        ...
        <div className="py-5">
          <details className="group">
            <summary className="flex justify-between items-center font-medium cursor-pointer list-none">
              <span className="text-red-500">
                این آموزش برای افرادی کاربرد دارد که نسخه کانتر 1.6 را از استیم
                خریداری کرده اند و نمی توانند وارد سرور هایی با آنتی چیت sXe
                Injected شوند.
              </span>
              <span className="p-6 transition group-open:rotate-180 text-red-200">
                <svg
            ...
            <ol className="list-decimal list-outside space-y-5 mt-4">
              <li>
                در ابتدا نرم افزار Steam را باز کنید و مانند عکس زیر از قسمت
                Library روی بازی کانتر 1.6 راست کلیک کنید و Properties را انتخاب
                کنید. در صفحه جدید منو Betas را انتخاب کنید و طبق عکس زیر Beta
                Participation را روی steam_legacy - Pre-25th Anniversary Build
                تنظیم کنید.
                <br />
                <ImageModal
                  src={
                    "https://client.royalcs.ir/index.php?rp=/images/kb/9_1.png"
                  }
                  alt="Turn Windows Defender Firewall"
                />
              </li>
              <li className="">
                hl.zip را از لینک زیر دانلود کنید و آن را باز کنید. سپس فایل
                hl.exe را کپی و در محل نصب بازی جایگزین کنید.
                <br />
                <br />
                <a
                  href="https://www.mediafire.com/file/n5ef1uugcow8uvt/hl.zip"
                  className="text-blue-500 hover:text-blue-300"
                >
                  دانلود فایل HL
                </a>
                ...
                <span className="text-yellow-600">
                  * برای پیدا کردن محل نصب بازی، طبق عکس زیر عمل کنید.
                </span>
                <ImageModal
                  src={
                    "https://client.royalcs.ir/index.php?rp=/images/kb/11_4.png"
                  }
                  alt="Turn Windows Defender Firewall"
                />
              </li>
              <li>
                پس از جایگزین کردن، بر روی فایل hl.exe در محل نصب بازی راست کلیک
                کنید و Send to Desktop را بزنید.
                <br />
                <ImageModal
                  src={
                    "https://client.royalcs.ir/index.php?rp=/images/kb/12_11.png"
                  }
                  alt="Turn Windows Defender Firewall"
                />
              </li>
              <li>
                در انتها کادر Target، متن زیر را اضافه کنید و آن را ذخیره کنید و
                هر بار برای اجرای بازی ابتدا نرم افزار استیم را باز کنید سپس این
                فایل را اجرا کنید.
                <br />
                <br />
                <pre className="bg-gray-800 text-white p-4 rounded-lg overflow-auto">
                  <code className="text-left" dir="ltr">
                    -game -high cstrike -noforcemparms -noforcemaccel
                    -noforcemspd -nofbo -nomsaa
                  </code>
                </pre>
                <br />
                <ImageModal
                  src={
                    "https://client.royalcs.ir/index.php?rp=/images/kb/14_11111.png"
                  }
                  alt="Turn Windows Defender Firewall"
                />
              </li>
